"""
MCP Server — Semantic Metric Registry
======================================
Wraps the metric registry and execution layer in a Model Context
Protocol (MCP) HTTP/JSON-RPC server.
...
Security:
  ...
  Full access log written to governance/mcp_access_log.yaml.
...
ACCESS_LOG_FILE = os.path.join(GOVERNANCE_PATH, 'mcp_access_log.yaml')
...
if __name__ == '__main__':
    ...
    logging.info(f"MCP Semantic Metric Registry server running on port {MCP_PORT}")
